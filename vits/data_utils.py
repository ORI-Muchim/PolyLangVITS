...
class TextAudioCollate():
    ...
    def __call__(self, batch):
        ...
        if self.return_ids:
            return input_padded, attention_padded, text_lengths, spec_padded, spec_lengths, wav_padded, wav_lengths, ids_sorted_decreasing
        return input_padded, attention_padded, text_lengths, spec_padded, spec_lengths, wav_padded, wav_lengths
